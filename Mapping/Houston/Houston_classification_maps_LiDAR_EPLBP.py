...
from Utils import zeroPadding, normalization, doPCA, modelStatsRecord, averageAccuracy, ssrn_SS_Houston_1
import h5py
...
def res4_model_ss():
    model_res4 = ssrn_SS_Houston_1.ResnetBuilder.build_resnet_2_2((1, img_rows, img_cols, img_channels), nb_classes)
...
sio.savemat('/home/amax/Documents/GCR/RNPRF-RNDFF-RNPMF/records/Houston/map/LiDAR_EPLBPmap.mat',adict)