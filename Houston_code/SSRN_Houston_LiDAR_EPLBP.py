...
best_weights_RES_path_ss4 = ('/home/amax/Documents/GCR/RNPRF-RNDFF-RNPMF/models/Houston/Houston_LiDAREPLBP_3-2_32_11x11_0.0001.hdf5')
 
######### Load data ########

mat_LiDAR = sio.loadmat('/home/amax/Documents/GCR/RNPRF-RNDFF-RNPMF/datasets/Houston/LiDAR_DSM_EPLBP.mat')
data_Houston = mat_LiDAR['LiDAR_DSM_EPLBP']
...
data = preprocessing.scale(data) #数据标准化
...
adict['traintime']=train_time

adict['Probability_LiDAR_EPLBP']=Probability
adict['maxPro_LiDAR_EPLBP']=pred_test_res4
adict['testlabel']=y_test

sio.savemat('/home/amax/Documents/GCR/RNPRF-RNDFF-RNPMF/records/Houston/Houston_LiDAREPLBP_3-2_32_11x11_0.0001.mat',adict)
